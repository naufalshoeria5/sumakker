                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="stats-icon green">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-envelope-plus" viewBox="0 0 16 16">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="stats-icon red">
                                            <i class="bi bi-envelope-open" style="font-size: 16px"></i>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
